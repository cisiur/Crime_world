...
The next architecture-sensitive E5-02 increment requires PM review and acceptance. It must use the accepted E5-01/E5-02A through E5-02F contract, preserve the accepted Local Collection outcomes plus crew-upkeep and recurring-income semantics, and avoid claiming that a complete economy, business gameplay, global tick-loop integration, save/load, pressure system, recruitment system, rival AI, or full campaign service already exists.
