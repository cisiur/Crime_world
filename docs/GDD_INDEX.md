...
1. review and accept E5-07 before implementation,
2. build on the accepted E5-01 money-flow, upkeep, and transaction-ledger contract plus the E5-02A through E5-02F foundation, E5-03 authored archetypes, E5-04 business-income slice, E5-05 recruitment-opportunity foundation, and E5-06 recruitment action,
3. preserve the existing package boundaries, including no `packages/content` dependency from `packages/domain`,
4. keep role/capacity growth, recruit upkeep generation, pressure systems, rival AI, save/load, campaign creation, and final UI pending until their accepted tasks.
